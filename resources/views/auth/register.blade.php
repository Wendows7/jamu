...
<div class="login-wrapper">
    <div class="login-card">
        ...
        <div class="login-desc">Buat akun untuk belanja, cek pesanan, dan dapatkan promo spesial!</div>
        <form class="login-form" method="POST" action="{{ route('auth.register.store') }}">
            <div>
                <label for="email">Name</label>
                <input type="name" id="name" name="name" placeholder="Nama lengkap kamu..." required>
            </div>
            <div>
                <label for="email">Email Address</label>
                <input type="email" id="email" name="email" placeholder="Alamat email kamu..." required>
            </div>
            <div>
